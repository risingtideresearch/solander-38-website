...
/** modified from https://github.com/pmndrs/drei/blob/master/src/core/GizmoViewcube.tsx
...
type EdgeCubeProps = { dimensions: XYZ; position: Vector3 } & Omit<
  GenericProps,
  "font" & "color"
>;
...
const EdgeCube = ({
  ...
  position,
  hoverColor = colors.hover,
}: EdgeCubeProps): React.JSX.Element => {
  const { tweenCamera } = useGizmoContext();
